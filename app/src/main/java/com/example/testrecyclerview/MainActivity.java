...
public class MainActivity extends AppCompatActivity implements DetecteurDeClicSurRecycler{
    ...
    private MonRecycleViewAdapteur mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MonRecycleViewAdapteur(getDataSource());
    ...
    private ArrayList<Donnee> getDataSource() {
        ...
        for (int index = 0; index < 20; index++) {
            Donnee obj = new Donnee("Texte principal " + index,"Texte auxiliaire " + index,R.drawable.leopard);
